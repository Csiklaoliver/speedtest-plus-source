...
|---|---|---|
| Download/upload exact or range | Engine progress mutation with one cached target | Needs device review |
| Realistic live movement | Progress-driven deterministic settling curve | Unit contract passes |
